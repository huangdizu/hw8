...
你的任務是完成下方的 `classify()`。這個函數可以將輸入的四字格，依據其內部結構，分成 11 種類別：
...
8.  ABAB: 例如，「慢來慢來」
9.  ABBA: 例如，「ABBA」(合唱團)
10. ABCD: 例如，「兩全其美」、「有夠討厭」
11. AAAA: 例如，「哈哈哈哈」、「嘿嘿嘿嘿」
...
classify(idioms)
test_pats <- strsplit("ABCC ABCA ABCB ABAC ABBC AABC AABB ABAB ABBA", " ")[[1]]
classify(test_pats)
# Should print out:
#> [1] "ABCB" "ABCD" "AABB" "ABAC" "ABCA" "AAAA"
#> [1] "ABCC" "ABCA" "ABCB" "ABAC" "ABBC" "AABC" "AABB" "ABAB" "ABBA"
```
